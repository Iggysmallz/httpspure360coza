...
const Hero = ({ onBookService, onWorkWithUs }: HeroProps) => {
  ...
  return (
    <section className="relative overflow-hidden px-4 pb-8 pt-12 sm:px-6 sm:pb-12 sm:pt-16 lg:px-8">
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mb-6 flex justify-center animate-fade-in">
          <span className="inline-flex items-center gap-2 rounded-full bg-secondary px-4 py-2 text-sm font-medium text-secondary-foreground">
            ...
            Cape Town's Premier Home Services
          </span>
        </div>
        ...
        {/* Feature badges */}
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 animate-fade-in" style={{ animationDelay: "0.4s" }}>
