...
const ContactSection = () => {
  const phoneNumber = "0764002332";
  const whatsappNumber = "27764002332";
  const email = "pure360s@gmail.com";
  ...
  return (
    <section id="contact" className="bg-muted/30 px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Phone */}
          <div className="flex flex-col items-center rounded-xl bg-background p-6 shadow-sm border border-border">
          ...
          <div className="flex flex-col items-center rounded-xl bg-background p-6 shadow-sm border border-border">
            ...
            <Button
              ...
              onClick={() => handleWhatsAppClick("Hello Pure360, I have an enquiry.")}
            >
              Chat with us
            </Button>
          </div>
          ...
          {/* Email */}
          <div className="flex flex-col items-center rounded-xl bg-background p-6 shadow-sm border border-border sm:col-span-2 lg:col-span-1">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a 
              href="#" 
              className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white hover:opacity-90 transition-opacity"
